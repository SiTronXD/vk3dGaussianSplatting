...
void DebugMessenger::createDebugMessenger(const VulkanInstance& instance, bool enableValidationLayers)
{
...
void DebugMessenger::cleanup()
{
	if (this->debugMessenger != VK_NULL_HANDLE)
		destroyDebugUtilsMessengerEXT(this->instance->getVkInstance(), this->debugMessenger, nullptr);
}
